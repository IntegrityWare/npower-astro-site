...
export const PRODUCTS = [
  ...
  },
  {
    ...
    shortName: "Visualize",
    tagline: "CAD import, IntegrityWare tessellation, bundled KeyShot, and mesh export for Blender, Modo, 3ds Max, and Maya.",
    ...
    useCases: [
      ...
      "Converting CAD data to meshes with IntegrityWare tessellation — low-poly for gaming and VR, or high-density for visualization and 3D printing, including large assemblies and large complex parts",
    ...
    whoIsItFor: [
      ...
      "Teams that need CAD-to-mesh output for gaming, virtual reality, visualization, or 3D printing",
    ...
    benefits: [
      ...
      "IntegrityWare’s world-class tessellation engine converts CAD data to meshes, with C# multi-threading for large assemblies and large complex parts — low-poly for gaming and VR, or high-density for visualization and 3D printing",
