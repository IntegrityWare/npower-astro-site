...
export const PRODUCTS = [
  {
    ...
    detail: {
      ...
      capabilities: [
        ...
        { name: "Analytic Shape Recognition", benefit: "Precision where the part is prismatic.", technical: "Automatically identifies and parameterizes analytic shapes — planes, cylinders, spheres, and cones — within the scanned mesh." },
