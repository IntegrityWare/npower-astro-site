...
export const WORKFLOWS = [
  { id: "reverse-engineering", name: "Reverse Engineering Mechanical Part", path: "/workflows/reverse-engineering", image: "/assets/wf-reverse-engineering.jpg", description: "Convert physical objects and 3D scans into editable CAD geometry using advanced reverse engineering workflows." },
...
export const NAV_ITEMS = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: "Reverse Engineering Mechanical Part", path: "/workflows/reverse-engineering" },
...
export const SAMPLE_VIDEOS = [
  ...
  { id: "v2", youtubeId: "F9U8-l1y3Kw", title: "Solids# MeshToCAD Recorded Webinar", product: "Power Surfacing RE Studio", type: "Overview", workflow: "Reverse Engineering Mechanical Part", level: "Beginner", duration: "34:20", thumbnail: ytThumb("F9U8-l1y3Kw") },
