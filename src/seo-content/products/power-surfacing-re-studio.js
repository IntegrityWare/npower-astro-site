...
export const RE_STUDIO_CONTENT = {
  ...
  features: [
    ...
    {
      title: "Includes Visualize and KeyShot",
      text: "RE Studio includes the full functionality of Power Surfacing Visualize plus the KeyShot render engine. Import engineering CAD, prepare assemblies for visualization, and render product visuals with no extra KeyShot license.",
    },
  ],
  workflow: {
