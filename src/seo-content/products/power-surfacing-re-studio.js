...
export const RE_STUDIO_CONTENT = {
  ...
  faqs: [
    ...
    { q: "Which file formats does it support?", a: "Inputs: STL and Wavefront OBJ files, plus SOLIDWORKS Topology Study meshes. Outputs: STEP, STL, Wavefront OBJ and native SOLIDWORKS features. PLY is not supported." },
