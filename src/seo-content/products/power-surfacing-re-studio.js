...
export const RE_STUDIO_CONTENT = {
  ...
  features: [
    ...
    {
      title: "Includes Viz and KeyShot",
      text: "RE Studio includes the full functionality of Power Surfacing Viz plus the KeyShot render engine. Import engineering CAD, prepare assemblies for visualization, and render product visuals with no extra KeyShot license.",
    },
  ],
  workflow: {
  ...
  faqs: [
    { q: "What is Power Surfacing RE Studio?", a: "Power Surfacing RE Studio is standalone Windows reverse-engineering and scan-to-CAD software that reconstructs 3D scan meshes, STL files and polygon models as editable NURBS surfaces and solids. It includes the complete Power Surfacing Studio modeling toolset, plus the full functionality of Power Surfacing Viz and the KeyShot render engine." },
    ...
    { q: "Which file formats does it support?", a: "Inputs: STL and Wavefront OBJ files, plus SOLIDWORKS Topology Study meshes. Outputs: STEP, STL, Wavefront OBJ and native SOLIDWORKS features." },
    { q: "How does RE Studio differ from Power Surfacing Studio?", a: "Power Surfacing Studio focuses on standalone CAD, Sub-D surfacing, sketching and feature-based modeling. RE Studio includes the entire Studio toolset and adds reverse-engineering capabilities for reconstructing scanned and polygonal mesh data. Both products include the full functionality of Power Surfacing Viz plus the KeyShot render engine." },
