...
export const PRODUCT_STRUCTURED_DATA = {
  ...
  "power-surfacing-visualize": {
    ...
    operatingSystem: "Windows",
    applicationCategory: "DesignApplication",
    applicationSubCategory: "CAD Visualization and Rendering Preparation",
    image: SITE_URL + "/assets/product-studio.webp",
    screenshot: SITE_URL + "/assets/product-studio.webp",
    publisher,
    provider: publisher,
    softwareRequirements: "Standalone Windows application; a full CAD seat is not required.",
    featureList: [
    ...
    offers: [
      offer("Perpetual License", "995", "/products/power-surfacing-visualize", "Introductory perpetual license purchase."),
      offer("Annual Subscription", "795", "/products/power-surfacing-visualize", "Annual subscription including updates and support."),
    ],
  },
