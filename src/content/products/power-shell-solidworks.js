// Single source of truth for the /products/power-shell-solidworks page.
...
const product = PRODUCTS.find((p) => p.id === "power-shell-solidworks");

export const POWER_SHELL_CONTENT = {
  meta: {
  ...
  relatedLinks: [
    ...
    { label: "Shelling and Thickening Workflow", path: "/workflows/shelling-thickening" },
