      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {PRODUCTS.map((p) => (
              <div key={p.id} className="bg-white border border-slate-200 rounded-xl p-6 hover:shadow-lg hover:border-blue-200 transition-all">
                ...
                <div className="space-y-2">
                  <Link to={p.path} className="flex items-center gap-2 text-sm font-medium text-blue-600 hover:text-blue-700">
            ...
            <div className="bg-slate-50 border border-slate-200 rounded-xl p-6">
              ...
              <Link to="/technology" className="flex items-center gap-2 text-sm font-medium text-blue-600 hover:text-blue-700">
