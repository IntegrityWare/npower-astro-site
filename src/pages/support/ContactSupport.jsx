              ...
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div>
                    ...
                    <select value={form.product} onChange={(e) => setForm({ ...form, product: e.target.value })} className="w-full px-4 py-2.5 border border-slate-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
                  ...
                  <div>
                    ...
                    <input type="text" required value={form.subject} onChange={(e) => setForm({ ...form, subject: e.target.value })} className="w-full px-4 py-2.5 border border-slate-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" />
                  </div>
                  <div>
              ...
              <div className="bg-slate-50 border border-slate-200 rounded-xl p-6">
                ...
                <div className="space-y-4 text-sm">
                  <a href="mailto:support@npowersoftware.com" className="flex items-center gap-3 text-slate-600 hover:text-blue-600 transition-colors">
                    <Mail className="w-5 h-5 text-blue-500" /> support@npowersoftware.com
                  </a>
                  ...
                  <div className="flex items-center gap-3 text-slate-600">
                    <Clock className="w-5 h-5 text-blue-500" /> Mon-Fri 9am-5pm EST
                  </div>
                </div>
              </div>
              <div className="bg-blue-50 border border-blue-200 rounded-xl p-6">
                <h3 className="font-bold text-blue-900 mb-2">Quick Tip</h3>
                <p className="text-sm text-blue-700">Include your product version, SOLIDWORKS version (if applicable), and a description of the issue for the fastest support response.</p>
              </div>
            </div>
          </div>
        </div>
