  ...
  return (
    <section className="relative bg-neutral-950 overflow-hidden min-h-[92vh] flex items-center">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 w-full">
        <div className="grid lg:grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)] gap-8 lg:gap-12 items-center">
          {/* copy */}
          <div className="hero-stagger min-w-0 relative z-10">
            ...
            <p className="text-base md:text-lg text-slate-400 mb-8 leading-relaxed max-w-xl">
              Power Surfacing provides Windows-based CAD, Sub-D modeling and reverse engineering software for industrial designers, engineers and manufacturers. Create dimension-driven sketches, feature-based solids, freeform Sub-D surfaces and editable CAD geometry from scanned meshes, ZBrush sculpted meshes, STL meshes, etc. Choose from standalone applications or integrated SOLIDWORKS add-ins.
            </p>
          ...
          {/* model video — loops forever, floats gently (visible on all screens) */}
          <div className="flex items-center justify-center mt-4 lg:mt-0">
            <div className="relative w-64 sm:w-80 md:w-[26rem] lg:w-[32rem] max-w-full aspect-square lg:translate-x-10">
