        ...
        <div className="grid lg:grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)] gap-12 items-center">
          ...
          <div className="hero-stagger min-w-0 relative z-10">
            ...
            <p className="text-base md:text-lg text-slate-400 mb-8 leading-relaxed max-w-xl">
              Power Surfacing provides Windows-based CAD, Sub-D modeling and reverse engineering software for industrial designers, engineers and manufacturers. Create dimension-driven sketches, feature-based solids, freeform Sub-D surfaces and editable CAD geometry from polygonal meshes produced by 3D scanners, 3D sculpting (i.e. ZBrush), CAD tessellation, 3D printing, topology optimization, etc. Choose from standalone applications or integrated SOLIDWORKS add-ins.
            </p>
