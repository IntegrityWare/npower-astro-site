    ...
    <section className="relative bg-slate-950 overflow-hidden min-h-[90vh] flex items-center">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-32">
        <div className="max-w-3xl">
          ...
          <p className="text-lg md:text-xl text-slate-400 mb-10 leading-relaxed max-w-2xl">Create, edit, and reverse engineer complex geometry with dimension-driven sketching, feature-based modeling, surface modeling, solids modeling, freeform Sub-D design, and NURBS/CAD precision.
