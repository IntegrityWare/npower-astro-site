...
const FAMILY = [
  { name: "Power Surfacing RE Studio", path: "/products/power-surfacing-re-studio", desc: "is standalone reverse-engineering software for reconstructing 3D scan meshes, sculpted meshes and STL files as editable NURBS surfaces and solids. Export reconstructed geometry to STEP and native SOLIDWORKS features. Power Surfacing RE Studio also includes the complete Power Surfacing Studio modeling toolset." },
