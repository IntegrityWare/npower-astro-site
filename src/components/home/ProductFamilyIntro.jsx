...
const FAMILY = [
  { name: "Power Surfacing Viz", path: "/products/power-surfacing-visualize", desc: "is a standalone CAD visualization and rendering-prep application. Import engineering models, convert CAD data to meshes with IntegrityWare’s world-class tessellation engine, create product visuals with KeyShot bundled, and prepare and export meshes for Blender, Modo, 3ds Max, and Maya — no extra KeyShot license and no full CAD seat required." },
  { name: "Power Surfacing Studio", path: "/products/power-surfacing-studio", desc: "is standalone CAD modeling software combining freeform Sub-D surfacing, dimension-driven sketching and feature-based solid modeling. It includes the full functionality of Power Surfacing Viz plus the KeyShot render engine. No third-party CAD license is required." },
