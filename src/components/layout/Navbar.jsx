...
export default function Navbar() {
  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-50 bg-neutral-950/80 backdrop-blur-xl supports-[backdrop-filter]:bg-neutral-950/70 border-b transition-all duration-300 ${scrolled ? "border-red-600/40 shadow-lg shadow-red-950/20" : "border-white/10"}`}>
      ...
      {/* Mobile Menu */}
      {mobileOpen &&
      <div className="md:hidden bg-neutral-950/90 backdrop-blur-xl border-t border-white/10 max-h-[calc(100vh-6rem)] overflow-y-auto">
          {NAV_ITEMS.map((item) =>
        <React.Fragment key={item.path}>
