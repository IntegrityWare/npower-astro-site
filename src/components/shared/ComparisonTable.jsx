...
const features = [
  ...
  { name: "Freeform Sub-D Design", products: ["power-surfacing-re-studio", "power-surfacing-studio", "power-surfacing-solidworks"] },
  ...
  { name: "Class A Surfacing", products: ["power-surfacing-solidworks"] },
  { name: "Advanced Shelling", products: ["power-shell-solidworks"] },
  { name: "Variable Wall Thickness", products: ["power-shell-solidworks"] },
