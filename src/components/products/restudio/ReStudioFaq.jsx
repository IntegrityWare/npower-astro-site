...
export const RE_STUDIO_FAQS = [
  ...
  { q: "Can it convert STL meshes into CAD?", a: "Yes. RE Studio imports STL files and reconstructs them as editable NURBS surfaces and solid bodies that can be exported to STEP, IGES or SAT." },
  ...
  { q: "Which file formats does it support?", a: "Inputs: STL and Wavefront OBJ files, including OBJ point clouds, plus SOLIDWORKS Topology Study meshes. Outputs: STEP, IGES and SAT. PLY and Parasolid are not supported." },
  ...
  { q: "How does RE Studio differ from Power Surfacing RE for SOLIDWORKS?", a: "RE Studio is a standalone Windows application that exports via STEP, IGES and SAT. Power Surfacing RE for SOLIDWORKS runs as an add-in inside SOLIDWORKS, where reconstructed geometry becomes SOLIDWORKS surface and solid bodies integrated with the feature tree." },
